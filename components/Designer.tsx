    ...
    return (
        <div className='flex w-full h-full'>
            <div className="p-4 w-full" onClick={() => {
                ...
                <div ref={droppable.setNodeRef} className={cn("bg-background max-w-[920px] h-full m-auto rounded-xl flex flex-col flex-grow items-center justify-start flex-1 overflow-y-auto", droppable.isOver && 'ring-4 ring-primary ring-inset')}>
...
function DesignerElementWrapper({ element }: { element: FormElementInstance }) {
    ...
    return (
        ...
        >
            ...
            {
                topHalf.isOver && (
                    <div className="absolute top-0 w-full h-[7px] rounded-md bg-primary rounded-b-none"></div>
                )}
            {
                bottomHalf.isOver && (
                    <div className="absolute bottom-0 w-full h-[7px] rounded-md bg-primary rounded-t-none"></div>
                )}
